...
const serviceSrc = ref(
  new URL("@/assets/style/image/video/service1.png", import.meta.url).href
);
...
const getSrcByIndex = (index) => {
  if (index === 1 || index === 2) {
    return new URL(
      `../assets/style/image/video/service${index}.png`,
      import.meta.url
    ).href;
  }

  return new URL(
    `../assets/style/image/video/service${index}.mp4`,
    import.meta.url
  ).href;
};
  ...
  <div class="container service-page other-page">
    <section>
      ...
      <div class="process-wrapper">
        ...
        <img
          class="process-pc"
          src="../assets/style/image/common/process.svg"
          alt=""
        />
        <img
          class="process-mob"
          src="../assets/style/image/common/process-mob.svg"
          alt=""
        />
      </div>
    </section>
