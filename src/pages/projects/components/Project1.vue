...
const projectData = [
  {
    name: "商品企劃 | 茶馬司 加大防潑水野餐墊",
    tags: ["#品牌建置", "#設計專案", "#數位營銷"],
    imgSrc: productUrl1,
  },
  {
    name: "品牌CI建置 | TEAMARS茶馬司訪山茶店",
    tags: ["#品牌建置", "#設計專案", "#數位營銷"],
    imgSrc: productUrl2,
  },
  {
    name: "商品企劃 | Ms.祕食 X 茶馬司限量星月中秋禮盒",
    tags: ["#品牌建置", "#設計專案", "#數位營銷"],
    imgSrc: productUrl3,
  },
  {
    name: "活動規劃 | 茶馬司 七夕情人節活動",
    tags: ["#品牌建置", "#設計專案", "#數位營銷"],
    imgSrc: productUrl4,
  },
];
...
<template>
  <Header />
  <div class="container detail-page other-page">
    <div class="banner">
      <img src="@/assets/style/image/projects/detail/bannera.png" alt="" />
    </div>
    <section>
      <div class="row">
        <Breadcrumb />
      ...
      <div class="detail-wrapper">
        <div class="title">品牌CI建置｜TEAMARS茶馬司訪山茶店</div>
        <div class="tags">
          <span class="dot"></span>#品牌建置 #設計專案 #數位營銷
        </div>
        <ul>
          <li>茶—香縈繞古道藏</li>
          <li>馬—啼嘶鳴時光往</li>
        ...
        <div class="detail_text">
          <p>茶馬司的靈感源於中國古代運送茶、馬、鹽商品進行貿易交換。</p>
          <p>TEAMARS茶馬司，茶馬司以歷史為根基，喚醒歷史深處的茶香 與記憶。</p>
          <p>”融合過去、現在和未來” 將美好體驗傳遞每一位消費 者全新感官。</p>
          <p>
            過去承載歷史，現在是希望，未來體現過去與未來的橋樑，每個階段擁有屬於其特有的符號，以時光交織，回歸茶文化的原點，
            從茶葉與馬到星球呈現，重塑茶文化，強調茶與心靈的多樣化體驗，打造出感性全面的茶馬司品牌。
          </p>
        </div>
        <div class="detail-photo">
          <div class="mobile-tasks">
            <img
              src="@/assets/style/image/projects/detail/projecta1-0.png"
              alt=""
            />
          </div>
          <img
            src="@/assets/style/image/projects/detail/projecta1-2.png"
            alt=""
          />
          <img
            src="@/assets/style/image/projects/detail/projecta2.png"
            alt=""
          />
          <img
            src="@/assets/style/image/projects/detail/projecta3.png"
            alt=""
          />
          <img
            src="@/assets/style/image/projects/detail/projecta4.png"
            alt=""
          />
          <video controls src="@/assets/style/image/video/service4.mp4"></video>
        </div>
      </div>
    </section>
    <section id="project">
