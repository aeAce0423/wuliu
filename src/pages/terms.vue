...
<template>
    <Header />
    <div class="container terms-page other-page">
        <section>
            <div class="row">
            ...
            <div class="terms-wrapper">
                <h4>歡迎來到五六文創官方網站</h4>
                <li>為了讓您能夠安心的使用本網站的各項服務與資訊，特此向您說明本網站的隱私權保護政策，以保障您的權益，請您詳閱下列內容：</li>
                <ol>
                    <li>隱私權保護政策的適用範圍</li>
                    ...
                    <li>與第三人共用個人資料之政策</li>
                    <li>本網站絕不會提供、交換、出租或出售任何您的個人資料給其他個人、團體、私人企業或公務機關，但有法律依據或合約義務者，不在此限。前項但書之情形包括不限於：</li>
                    <ol>
                        <li>經由您書面同意。</li>
                        <li>法律明文規定。 為免除您生命、身體、自由或財產上之危險。</li>
